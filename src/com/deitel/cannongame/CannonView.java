   ...
   implements SurfaceHolder.Callback
{
   ...
   public static int GAME_LEVEL = 1; // sections in the target
   ...
   public void newGame()
   {
      ...
      blockerVelocity = initialBlockerVelocity + (GAME_LEVEL*5); // set initial velocity
      targetVelocity = initialTargetVelocity + (GAME_LEVEL*5); // set initial velocity
   ...
   private void updatePositions(double elapsedTimeMS)
   {
      ...
      if (cannonballOnScreen) // if there is currently a shot fired
      {
            ...
            cannonball.y - cannonballRadius < blocker.end.y)
         {
            ...
            if(score < (15 * GAME_LEVEL)){
            	score = 0;
            }
            else{
            score = score - (15 * GAME_LEVEL);
            }
            // play blocker sound
   ...
   public void drawGameElements(Canvas canvas)
   {
      ...
      canvas.drawText(getResources().getString(
    	         R.string.highest_Score, highestScore), 30, 90, textPaint);
      ...
      final DialogFragment gameResult = 
         new DialogFragment()
         {
            ...
            public Dialog onCreateDialog(Bundle bundle)
            {
               ...
               if(last_msg.equalsIgnoreCase("You win!") && GAME_LEVEL <= 9){
